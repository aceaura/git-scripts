...
git config --global alias.sa '!f() { echo "usage: git <alias> [<args>]"; echo ""; echo "Log commands:"; echo "   l              Show compact log with graph and colors"; echo "   lf             Show detailed log with file changes"; echo "   lb             Open repository in browser"; echo ""; echo "Tag commands:"; echo "   t              Create and push patch version tag (x.y.Z+1)"; echo "   tt             Create and push minor version tag (x.Y+1.0)"; echo "   ttt            Create and push major version tag (X+1.0.0)"; echo ""; echo "Sync commands:"; echo "   s              Sync aliases between local and remote"; echo "   sr             Force upload local aliases to remote"; echo "   sl             Force download remote aliases to local"; echo "   sd <name>      Delete alias from both local and remote"; echo "   sa             Show this help message"; echo ""; echo "Installed aliases:"; git config --global -l | grep ^alias | cut -d= -f1 | sed s/alias.// | sort; }; f'
